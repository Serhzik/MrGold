...
//		Debug.Log (YoutubeVideo.Instance.RequestVideo("https://www.youtube.com/watch?v=J7UwSVsiwzI", 720));
		videoPlayer.url = YoutubeVideo.Instance.RequestVideo(VideoURL, 720);
